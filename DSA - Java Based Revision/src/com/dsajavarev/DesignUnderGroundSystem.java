...
//    }
//    static HashMap<String, Pair<Integer, Integer>> checkoutMap = new HashMap<String, MinimumCostPath.Pair<Integer, Integer>>(); // Route - {TotalTime, Count}
//    static HashMap<Integer, Pair<String, Integer>> checkInMap = new HashMap<Integer, Pair<String, Integer>>();  // Uid - {StationName, Time}
//
